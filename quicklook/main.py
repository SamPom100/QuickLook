...
stockList = [
    'AAPL', 'MSFT', 'GOOGL', 'AMZN', 'META', 'NVDA', 'JPM', 'UBER', 'UNH', 'COST', 'MA'
]
...
for STOCK in stockList:
    ...
    # earliest date in the truncated data
    earliest_date = revenue[0]['date']
    stock_price_history = datasource.get_stock_price_history(STOCK, earliest_date, today)
